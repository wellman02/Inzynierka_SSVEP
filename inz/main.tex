...
\usepackage{tabularx} % to do tabelek
\usepackage{float} % dla [H]
\usepackage{lipsum}           % lorem ipsum
\usepackage{tikz}
\usepackage{graphicx}     % do wstawiania PDF-ów/obrazków
\usepackage{multirow}
\usepackage{booktabs} 
...
%	ROZDZIAŁ 4
%----------------------------------------------------------------------------------------
\include{chapter4} % chapter4.tex zawiera treść rozdziału 3
...
\appendix
\include{protokol} 
\include{ankieta} % conclusions.tex zawiera treść zakończenia/podsumowania pracy dyplomowej
\end{appendix}
% ----------------------------------------------------------------------------------------
% Koniec dokumentu
\end{document}
